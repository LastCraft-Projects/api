...
import net.lastcraft.packetlib.libraries.effect.data.CraftParticleColor;
import net.lastcraft.packetlib.libraries.effect.data.CraftParticleData;
import net.lastcraft.packetlib.libraries.effect.data.CraftParticleOrdinaryColor;
