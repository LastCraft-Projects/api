...
import net.lastcraft.api.effect.PlayerGlowing;
import net.lastcraft.dartaapi.loader.DartaAPI;
import net.lastcraft.packetlib.libraries.effect.data.*;
import net.lastcraft.packetlib.libraries.effect.glow.CraftPlayerGlowing;
import net.lastcraft.packetlib.libraries.effect.glow.GlowListener;
import net.lastcraft.packetlib.libraries.effect.glow.GlowManager;
...
public class ParticleAPIImpl implements ParticleAPI {
    ...
    public ParticleAPIImpl(DartaAPI dartaApi) {
        this.dartaAPI = dartaApi;

        this.firework = new CraftFireworkListener(dartaApi);
