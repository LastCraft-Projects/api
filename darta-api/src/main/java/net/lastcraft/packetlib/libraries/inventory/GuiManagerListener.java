...
import net.lastcraft.api.inventory.action.ClickActionWithCursor;
...
public class GuiManagerListener extends DListener<DartaAPI> {
    ...
    GuiManagerListener(DartaAPI dartaAPI) {
        super(dartaAPI);
    }
