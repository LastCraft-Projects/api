...
public class MagmaHelpGui extends Gui {
    
    public MagmaHelpGui(GuiDefaultContainer container, Language lang) {
        super(container, lang, lang.getMessage( "GUI_DONATE_GUI_NAME") + " Magma");
    }
