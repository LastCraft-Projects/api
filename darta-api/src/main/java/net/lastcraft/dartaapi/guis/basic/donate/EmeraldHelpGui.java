...
public class EmeraldHelpGui extends Gui {

    public EmeraldHelpGui(GuiDefaultContainer container, Language lang) {
        super(container, lang, lang.getMessage("GUI_DONATE_GUI_NAME") + " Emerald");
    }
